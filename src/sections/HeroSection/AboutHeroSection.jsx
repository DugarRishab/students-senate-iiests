...
const AboutHeroSection = () => {
    return (
        <section id='AboutHeroSection' className='w-full mx-auto max-w-[1700px] min-h-max lg:h-[calc(100vh-4rem)] 2xl:h-full flex relative z-0'>
            <div id='hero_left' className='flex flex-col w-1/2 h-full pl-4 min-[430px]:pl-6 min-[590px]:pl-7 sm:pl-8 md:pl-9 lg:pl-9 xl:pl-10 py-7 min-[430px]:py-8 min-[590px]:py-10 sm:py-12 md:py-14 lg:py-0'>
                <img src="./assets/imgs/senate_logo.png" alt="Senate Logo" className='w-10 min-[430px]:w-12 min-[590px]:w-14 sm:w-16 md:w-20 lg:w-32 xl:w-32' />
