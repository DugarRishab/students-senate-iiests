export default function Desktop9() {
    return (
        <section className="min-h-screen relative mx-auto">
            {/* top */}
            <div className="w-full flex justify-end mb-36">
                <div className="h-[20%] w-[60%] text-6xl font-bold p-8 pt-28 text-tintWhite bg-blue">
            ...
            <div className="w-full flex">
                <div className="flex justify-end w-[40%]">
                    <div className="p-6 w-[400px] text-yellow bg-blue">
                        <h2 className="text-5xl mb-3 font-[Poppins]">
                ...
                <div className="ml-36">
                    <div className="p-6 w-[400px] text-black bg-transparent">
                        <h2 className="text-5xl mb-3 font-[Poppins]">
                            The General Council
                        </h2>
                        <p className="text-base">
